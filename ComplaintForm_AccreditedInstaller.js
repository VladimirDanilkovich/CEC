...
describe('Accredited Installer', function() {
  ...
  it('Accredited Installer', async function() {
    await driver.get("https://verticdev-cleanenergycouncil.cs58.force.com/ComplaintForm")
    {
      ...
      await dropdown.findElement(By.xpath("//option[. = 'Make a complaint against an accredited installer']")).click()
    }
    ...
    await driver.wait(until.elementLocated(By.xpath("//h2[contains(.,\'Your dispute has been submitted successfully\')]")), 15000)
  })
})
